        ...
        <DialogContent dividers={scroll === "paper"}>
          ...
          >
            ...
            <Typography variant="p" color="black">
              ...
              <br />
              それぞれのノードを選択することで、論文の詳細を見ることができます。また、隣り合っている論文を強調して表示します。
              <br />
              青色で表示されているノードは選択した論文で、紫色で表示されているものは類似論文となっています。
              類似論文は選択すると赤色で表示されます。
            </Typography>
            ...
            <Typography variant="p" color="black">
              ...
              <br />
              ノードラベルはタイトル、キーワード、著者、年代、なしに変更可能です。
              <br />
              ラベル表示量は一部にすることで選択したノードとつながりを持つものが表示され、全体にすることですべてのノードで表示されます。
            </Typography>
            <Typography sx={{ pt: 2 }} variant="h6" color="black">
              論文詳細について
            </Typography>
            <Typography variant="p" color="black">
              ...
              また、「generate a network out of this
              paper」を選択することでその論文のネットワークを再構築します。
            </Typography>
          </DialogContentText>
        </DialogContent>
      </Dialog>
